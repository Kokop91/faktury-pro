...
class PozycjaOferty(Base):
    __tablename__ = "pozycje_ofert"

    id: Mapped[int] = mapped_column(primary_key=True)
    oferta_id: Mapped[int] = mapped_column(ForeignKey("oferty.id"), nullable=False)
    ...
    oferta: Mapped["Oferta"] = relationship(back_populates="pozycje")
